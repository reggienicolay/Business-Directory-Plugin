...
### Performance Architecture (v0.1.10)
...
Assets are **registered** on `wp_enqueue_scripts` and **conditionally enqueued** by shortcodes and templates as needed. All assets use the `BD_VERSION` constant (`0.1.10`) for cache busting.
