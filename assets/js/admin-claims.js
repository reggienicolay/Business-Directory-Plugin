...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $('.bd-approve-btn').on('click', function() {
            currentClaimId = $(this).data('claim-id');
            $('#bd-approve-modal').fadeIn(200);
        });
        
        // Reject button click
        $('.bd-reject-btn').on('click', function() {
            currentClaimId = $(this).data('claim-id');
            $('#bd-reject-modal').fadeIn(200);
        });
        
        // Modal close buttons
        $('.bd-modal-close, .bd-modal-cancel').on('click', function() {
        ...
        // Confirm Approve
        $('.bd-confirm-approve').on('click', function() {
        ...
        // Confirm Reject
        $('.bd-confirm-reject').on('click', function() {
            if (!currentClaimId) return;
...
jQuery(document).ready(function($) {
    ...
    $(document).on('click', '.bd-confirm-approve', function() {
