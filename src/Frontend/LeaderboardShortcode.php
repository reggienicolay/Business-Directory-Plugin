...
class LeaderboardShortcode {
    ...
    private static $ranks = array(
        array( 'name' => 'Newcomer',       'min' => 0,    'color' => '#94a3b8', 'bg' => 'rgba(148,163,184,.1)' ),
        array( 'name' => 'Neighbor',        'min' => 50,   'color' => '#3b82f6', 'bg' => 'rgba(59,130,246,.1)' ),
        array( 'name' => 'Explorer',        'min' => 200,  'color' => '#2CB1BC', 'bg' => 'rgba(44,177,188,.1)' ),
        array( 'name' => 'Insider',         'min' => 500,  'color' => '#f59e0b', 'bg' => 'rgba(245,158,11,.1)' ),
        array( 'name' => 'Local Legend',    'min' => 1000, 'color' => '#8b5cf6', 'bg' => 'rgba(139,92,246,.1)' ),
    );
