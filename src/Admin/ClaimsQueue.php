...
class ClaimsQueue {
    ...
    public function __construct() {
        ...
        add_action('admin_post_bd_approve_claim', [$this, 'handle_approve']);
        add_action('admin_post_bd_reject_claim', [$this, 'handle_reject']);
    ...
    public function enqueue_scripts($hook) {
        if ($hook !== 'bd_business_page_bd-pending-claims') {
            return;
        }
        
        $plugin_url = plugin_dir_url(dirname(dirname(__FILE__)));
        
        wp_enqueue_style('bd-admin-claims', 
            $plugin_url . 'assets/css/admin-claims.css',
            [],
            '1.0.0'
        );
        
        wp_enqueue_script('bd-admin-claims',
        ...
        wp_localize_script('bd-admin-claims', 'bdClaimsAdmin', [
                            ...
                            <div class="bd-claim-body">
                                ...
                                <div class="bd-proof-files">
                                    ...
                                    <div class="bd-files-grid">
                                        <?php foreach ($claim['proof_files'] as $file_id): 
