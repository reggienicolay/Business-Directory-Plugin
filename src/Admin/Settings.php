...
class Settings
{
    ...
    public function __construct()
    {
        ...
        add_action('admin_menu', [$this, 'add_pending_menu'], 20);
        add_action('admin_init', [$this, 'register_settings']);
        add_filter('views_edit-bd_business', [$this, 'add_pending_view']);
        add_filter('post_row_actions', [$this, 'add_approve_link'], 10, 2);
        add_action('admin_post_bd_approve_business', [$this, 'handle_approve']);
        add_action('admin_footer', [$this, 'inject_approve_buttons']);
    }
    ...
    public function inject_approve_buttons()
    {
        ...
        if ($pagenow === 'edit.php' && isset($_GET['post_type']) && $_GET['post_type'] === 'bd_business' && isset($_GET['post_status']) && $_GET['post_status'] === 'pending') {
