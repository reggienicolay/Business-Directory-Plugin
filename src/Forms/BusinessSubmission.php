...
class BusinessSubmission {
	...
	public function __construct() {
		add_shortcode( 'bd_submit_business', array( $this, 'render_form' ) );
	...
	public function enqueue_assets() {
		if ( is_singular() || is_page() ) {
			...
			if ( $post && has_shortcode( $post->post_content, 'bd_submit_business' ) ) {
				wp_enqueue_style( 'bd-submission-form', BD_PLUGIN_URL . 'assets/css/submission-form-premium.css', array(), BD_VERSION );
				wp_enqueue_script( 'bd-submission-form', BD_PLUGIN_URL . 'assets/js/submission-form.js', array( 'jquery' ), BD_VERSION, true );
