		...
		<div class="bd-quick-bar-inner">
			...
			<div class="bd-quick-right">
				...
				if ( class_exists( '\BD\Frontend\ListDisplay' ) ) {
					echo \BD\Frontend\ListDisplay::render_save_button(
						array(
			...
			<article class="bd-card bd-card-padded">
				...
				<?php if ( ! empty( $tags ) ) : ?>
					<div class="bd-tags-row">
						<?php foreach ( $tags as $business_tag ) : ?>
							<a href="<?php echo esc_url( get_term_link( $business_tag ) ); ?>" class="bd-tag">
								<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
									<circle cx="12" cy="12" r="4" />
								</svg>
								<?php echo esc_html( $business_tag->name ); ?>
							</a>
						<?php endforeach; ?>
					</div>
				<?php endif; ?>
			...
			<article class="bd-card bd-card-padded" id="reviews">
				...
				<div class="bd-review-form-section" id="write-review">
					...
					<?php if ( is_user_logged_in() ) : ?>
						...
						$display_name = get_user_meta( $review_user->ID, 'bd_display_name', true );
						if ( empty( $display_name ) ) {
							$display_name = $review_user->display_name;
						}
